...
use crate::{kucoin::BybitTradingPair, normalized::types::NormalizedQuote, CexExchange};

#[serde_as]
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, PartialOrd)]
pub struct BybitBookTicker {
    #[serde(rename = "s")]
...
impl PartialEq<NormalizedQuote> for BybitBookTicker {
